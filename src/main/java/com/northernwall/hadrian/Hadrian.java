...
public class Hadrian {
    ...
    private void setupJetty() {
        ...
        routingHandler.add(MethodRule.GET, TargetRule.EQUALS, "/v1/service/audit", new ServiceAuditGetHandler(dataAccess), true);
        routingHandler.add(MethodRule.GET, TargetRule.EQUALS, "/v1/service/auditOutput", new ServiceAuditOutputGetHandler(dataAccess), true);
