...
import com.northernwall.hadrian.handlers.host.HostCommentHandler;
...
import com.northernwall.hadrian.handlers.ssh.SshModuleGetHandler;
...
import com.northernwall.hadrian.handlers.vip.VipHostHandler;
...
public class Hadrian {
    ...
    private void setupJetty() {
        ...
        routingHandler.add(MethodRule.PUTPOST, TargetRule.EQUALS, "/v1/vip/host", new VipHostHandler(dataAccess, gson, accessHelper, workItemProcessor), true);
        ...
        routingHandler.add(MethodRule.PUTPOST, TargetRule.EQUALS, "/v1/host/comment", new HostCommentHandler(dataAccess, gson, accessHelper), true);
        ...
        routingHandler.add(MethodRule.GET, TargetRule.EQUALS, "/v1/module/sshaccess", new SshModuleGetHandler(dataAccess, gson, sshAccess), true);
