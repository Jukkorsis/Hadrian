...
public class MessagingCoodinatorTest {
    ...
    public void sendMessageTest() {
        ...
        Team team = new Team("test Team", null, "myTeam", null, null, "black", "testTeam");
        Service service = new Service("Test Service", team.getTeamId(), "Desc", "service", "gitGroup", "Not in scope", false, false, false, "not HA", "com.northernwall", true, true, true, true, FindBugsLevel.report, "Maven", null, null, null, null, 60, true);
        Module module = new Module("Test Module", service.getServiceId(), ModuleType.Deployable, null, null, null, null, null, null, null, 0, 0, 0, null, null, null, null, null, null, null, null, null, 0, null, null, 0, null, 0, null, null);
