...
public class MessagingCoodinatorTest {
    ...
    public void sendMessageTest() {
        ...
        Service service = new Service("Test Service", team.getTeamId(), "Desc", "service", "gitGroup", "Not in scope", "com.northernwall", true, true, true, true, FindBugsLevel.report, "Maven", null, null, null, null, 60, true);
